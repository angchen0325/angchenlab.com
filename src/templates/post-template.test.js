...
describe('PostTemplate', () => {
  ...
  it('renders correctly', () => {
    ...
    expect(rendered).not.toContain("At least this isn't a full screen popup");
    expect(rendered).not.toContain('SHARE THIS POST');
    expect(rendered).not.toContain('example@domain.com');
    expect(rendered).not.toContain('YOU MIGHT ALSO LIKE');
  });
});
